...
class MyArchivedIssuesList extends StatefulWidget {
  const MyArchivedIssuesList({super.key, required this.bloc});
  final ArchiveBloc bloc;

  @override
  State<MyArchivedIssuesList> createState() => _MyArchivedIssuesListState();
}

class _MyArchivedIssuesListState extends State<MyArchivedIssuesList> {
  @override
  void initState() {
    super.initState();
    widget.bloc.add(GetMyArchivedIssuesEvent());
  }
