...
class HiringRequestList extends StatefulWidget {
  const HiringRequestList({super.key, required this.bloc});
  final HiringRequestsBloc bloc;

  @override
  State<HiringRequestList> createState() => _HiringRequestListState();
}

class _HiringRequestListState extends State<HiringRequestList> {
  @override
  void initState() {
    super.initState();
