...
class HiringRequestPublishedItem extends StatelessWidget {
  const HiringRequestPublishedItem({
    super.key,
    required this.hiringRequestModel,
  });
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text("Job Title: ${hiringRequestModel.jopTitle}"),
