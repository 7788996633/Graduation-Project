...
class ReportSalariesScreen extends StatefulWidget {
  const ReportSalariesScreen({super.key});

  @override
  State<ReportSalariesScreen> createState() => _ReportSalariesScreenState();
}

class _ReportSalariesScreenState extends State<ReportSalariesScreen> {
  bool _loading = false;
  ...
  Future<void> _generateAndOpenReport() async {
    ...
    try {
      final data = await ReportService().reportSalaries();
