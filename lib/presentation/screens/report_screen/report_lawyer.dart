...
class ReportLawyerScreen extends StatefulWidget {


  const ReportLawyerScreen({super.key,});

  @override
  State<ReportLawyerScreen> createState() => _ReportLawyerScreenState();
}

class _ReportLawyerScreenState extends State<ReportLawyerScreen> {
  bool _loading = false;
  ...
  Future<void> _generateAndOpenPdf() async {
    ...
    try {
      final data = await ReportService().reportLawyer();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('تقرير المحامي'),
      ),
