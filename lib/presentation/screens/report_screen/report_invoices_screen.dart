...
class ReportInvoicesScreen extends StatefulWidget {
  const ReportInvoicesScreen({super.key});

  @override
  State<ReportInvoicesScreen> createState() => _ReportInvoicesScreenState();
}

class _ReportInvoicesScreenState extends State<ReportInvoicesScreen> {
  bool _loading = false;
  ...
  void initState() {
    super.initState();
    _generateAndOpenPdf(); // استدعاء التقرير تلقائياً عند الدخول
  }
  ...
  Future<void> _generateAndOpenPdf() async {
    ...
    try {
      final data = await ReportService().reportInvoices();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('تقرير الدفعات المالية'),
      ),
