          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildInfoRow('Start Date', furlough.startDate.toLocal().toString()),
                Divider(color: Colors.deepPurple.shade100, thickness: 1.5),
                _buildInfoRow('End Date', furlough.endDate.toLocal().toString()),
                Divider(color: Colors.deepPurple.shade100, thickness: 1.5),
                ...
                Divider(color: Colors.deepPurple.shade100, thickness: 1.5),
                _buildInfoRow('Created At', furlough.createdAt?.toLocal().toString() ?? '-'),
                Divider(color: Colors.deepPurple.shade100, thickness: 1.5),
                _buildInfoRow('Updated At', furlough.updatedAt?.toLocal().toString() ?? '-'),
              ],
            ),
          ),
        ),
