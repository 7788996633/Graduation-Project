  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomActionAppBar(
        title: ' Required Document Details',
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _infoText('ID', requiredDocument.id.toString()),
            _infoText('Type', requiredDocument.requireFileType),
            _infoText('Status', requiredDocument.status),
            _infoText('Note', requiredDocument.note ?? 'No note'),
